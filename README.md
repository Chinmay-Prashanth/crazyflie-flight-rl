# Crazyflie 2.x — RL Locomotion in Isaac Lab

![poster](media/poster.png)

Massively parallel reinforcement-learning simulation of the **Bitcraze Crazyflie 2.x**
in [NVIDIA Isaac Lab](https://github.com/isaac-sim/IsaacLab), rendered at
1920×1080 with a tracking camera. The nano-quadcopter flies to goal positions, close tracking camera.

▶ **Demo video:** [`videos/quadcopter-flight.mp4`](videos/quadcopter-flight.mp4)

## Task

| | |
|---|---|
| Environment | `Isaac-Quadcopter-Direct-v0` |
...
/path/to/this/repo/scripts/encode.sh rl-video-step-0.mp4 quadcopter-flight.mp4
